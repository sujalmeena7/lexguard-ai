...
# ── Paths — resolve to project root (3 levels up from core/auditor/)
_PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
DATA_DIR   = os.path.join(_PROJECT_ROOT, "storage", "local")
DB_DIR     = os.path.join(_PROJECT_ROOT, "storage", "vector_db")
STORE_PATH = os.path.join(_PROJECT_ROOT, "storage", "docstore.json")
WORKSPACE_DB_DIR = os.path.join(_PROJECT_ROOT, "storage", "workspaces")
