...
export default function AuditPage() {
        ...
        for (const chunk of lines) {
          ...
          try {
            ...
            if (event.type === "progress") {
              ...
              setSuccessMessage("Audit saved in Audit History. You can access and download the report from there if you lose data here.");
  ...
  const handleDownloadReport = useCallback(() => {
    ...
    generateAuditPDF(analysisResult, uploadedFileName ?? undefined);
      ...
      <div className="p-6 space-y-6 max-w-6xl mx-auto">
        ...
        {successMessage && (
          <motion.div
            ...
            className="rounded-lg border border-[#34D399]/30 bg-[#34D399]/10 p-4 text-sm text-[#34D399]"
          >
            <span className="font-semibold">Saved: </span>{successMessage}
          </motion.div>
        )}
